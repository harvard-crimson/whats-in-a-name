...
PROJECT_SLUG = 'whats-in-a-name'

# Project name to be used in file paths
PROJECT_FILENAME = 'whats_in_a_name'

# The name of the repository containing the source
REPOSITORY_NAME = 'whats-in-a-name'
GITHUB_USERNAME = 'harvard-crimson'
REPOSITORY_URL = 'git@github.com:%s/%s.git' % (GITHUB_USERNAME, REPOSITORY_NAME)
REPOSITORY_ALT_URL = None # 'git@bitbucket.org:nprapps/%s.git' % REPOSITORY_NAME'

# Project name used for assets rig
# Should stay the same, even if PROJECT_SLUG changes
ASSETS_SLUG = 'whats-in-a-name'

"""
DEPLOYMENT
"""
PRODUCTION_S3_BUCKET = {
    'bucket_name': 'features-dev.thecrimson.com',
    'region': 'us-east-1'
}
...
def configure_targets(deployment_target):
    ...
    if deployment_target == 'production':
        ...
        S3_BASE_URL = 'http://features-dev.thecrimson.com/%s' % (PROJECT_SLUG)
